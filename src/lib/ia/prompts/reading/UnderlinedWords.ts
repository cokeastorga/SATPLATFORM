...
📌 Requirements:
- "pasaje": Write a sentence or very short passage **40 to 120 words. In the passage, one word or phrase must be **underlined** using double underscores before and after it, like __this__. Only one underlined section per passage.
