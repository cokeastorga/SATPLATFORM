...
📌 Requirements:
- "pasaje": A formal academic passage of ** 40 and 100 words ONLY** (strictly enforced). The topic must be related to science, history, or social studies, but do NOT use overused SAT topics (e.g., penicillin, Rosetta Stone, Industrial Revolution). Do NOT simply copy the topic into the question or options.
