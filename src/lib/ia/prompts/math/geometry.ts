...
- **pasaje**: A concise context or word problem (20–150 words) in English, providing a real-world or geometric setup for the problem (e.g., involving shapes, areas, volumes, or coordinate geometry). Include only if relevant to the question; otherwise, set to an empty string (""). Ensure all words are properly spaced and readable, avoiding merged or concatenated text.
