...
- **pasaje**: A concise context or word problem (20–50 words) in English, providing a real-world or mathematical setup for the algebra problem (e.g., involving linear equations, systems, or inequalities). Include only if relevant to the question; otherwise, set to an empty string (""). Ensure all words are properly spaced and readable, avoiding merged or concatenated text.
