...
- **pasaje**: A concise context or word problem (40-100 words) in English, providing a real-world or data-driven setup for the problem (e.g., involving rates, percentages, proportions, or data interpretation). Include only if relevant to the question; otherwise, set to an empty string (""). Ensure all words are properly spaced and readable, avoiding merged or concatenated text.
